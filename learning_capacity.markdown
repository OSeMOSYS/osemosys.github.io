...
<div class="container my-5">
  <h3 class="alt-h3 text-center mb-4">Explore EMP Events</h3>
  <div class="emp-slider">

    <!-- EMP-LAC -->
    <div class="emp-card text-left p-4">
      <h4 class="alt-h4 text-center">EMP-LAC 2025 – Buenos Aires, Argentina</h4>
      <img src="/assets/img/EMP/emp-lac-2024.png" class="img-fluid img-border mb-3 d-block mx-auto" alt="EMP-LAC 2025">
    ...
    <!-- EMP-G -->
    <div class="emp-card text-left p-4">
      <h4 class="alt-h4 text-center">EMP-G 2024 – Trieste, Italy</h4>
      <img src="/assets/img/EMP/emp-g-2024.png" class="img-fluid img-border mb-3 d-block mx-auto" alt="EMP-G 2024">
    ...
    <!-- EMP-A -->
    <div class="emp-card text-left p-4">
      <h4 class="alt-h4 text-center">EMP-A 2024 – Accra, Ghana</h4>
      <img src="/assets/img/EMP/emp-a-2024.png" class="img-fluid img-border mb-3 d-block mx-auto" alt="EMP-A 2024">
      <p>Held from 20–31 May at GIMPA. Ten teams worked on national energy models.</p>
      <details>
        <summary class="btn btn-sm btn-outline toggle-arrow">Show Outputs</summary>
        <ul class="mt-2">
    ...
    <!-- EMP-Adjacent Events -->
    <div class="emp-card text-left p-4">
      <h4 class="alt-h4 text-center">EMP-adjacent Events</h4>
      <p>These capacity building events used the OSeMOSYS methodology outside the formal EMP series:</p>
      <ul>
